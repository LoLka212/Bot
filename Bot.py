...
bot = commands.Bot(command_prefix = "+", intents=intents, test_guilds=[896655023600185344])
bot.remove_command("help")
slash = commands.InteractionBot()
...
async def help(ctx):
	...
	embed1.add_field(name=f'+saper', value='Команда для игры --"сапёр"')
	embed1.add_field(name=f'+knb', value='Команда для игры --"камень, ножницы, бумага"')
	embed1.add_field(name=f'+шар', value='Команда для игры --"шар"')
	embed2 = discord.Embed(title = 'Модерация 📚')
	embed2.add_field(name=f'+mute', value='lamute <участник> (время) <причина>')
	embed2.add_field(name=f'+ban', value='laban <участник> (время) <причина>')
	embed2.add_field(name=f'+kick', value='lakick <участник> <причина>')
	embed2.add_field(name=f'+unmute', value='launmute <участник>')
	embed3 = discord.Embed(title = 'Информация 📙')
	embed3.add_field(name=f'+serverinfo', value='Информация о сервере')
	embed3.add_field(name=f'+userinfo', value='Информация о Участнике')
	embed3.add_field(name=f'+avatar', value='аватар участника')
	embed3.add_field(name=f'+suggest', value='идеи для сервера')
	embed4 = discord.Embed(title = 'Фан 📘')
	embed4.add_field(name=f'+kiss', value='поцеловать участника')
	embed4.add_field(name=f'+hug', value='обнять участника')
	embed4.add_field(name=f'+slap', value='шлепнуть участника')
	embed4.add_field(name=f'+teleportation', value='телепортировать участника с одного голосового канала на другой')
